...
export default function Home() {
  return <>
    ...
    <div className="text-white container mx-auto py-10 space-y-8">
      <h1 className="text-white text-3xl font-bold text-center">Your Fans can Buy You a chai</h1>
    ...
    <div className="text-white container mx-auto space-y-8 py-10 flex flex-col justify-center items-center">
      <h1 className="text-white text-3xl font-bold text-center">Learn More About Us</h1>
